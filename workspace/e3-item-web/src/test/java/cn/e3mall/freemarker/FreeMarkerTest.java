...
public class FreeMarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		//3、设置模板文件保存的目录
		configuration.setDirectoryForTemplateLoading(new File("D:\\工作区\\myshop\\workspace\\e3-item-web\\src\\main\\webapp\\WEB-INF\\ftl"));
...
//		Template template = configuration.getTemplate("hello.ftl");
		...
		Student student = new Student(1, "小黄", 18, "梅州");
