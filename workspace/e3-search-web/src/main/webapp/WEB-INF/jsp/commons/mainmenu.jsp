...
<!----百度统计代码结束-------></div>
    ...
    <div class="menu1">
      <ul>
            <li><a name="sfbest_Uhead_Uhead_nav_nav1" class="trackref" href="http://localhost:8082">首页</a></li>
            				<li id="cat1">
					<a name="sfbest_Uhead_Uhead_nav_nav2" href="#" class="trackref 
																																			">优选生鲜</a>
									</li>
							<li id="cat2">
					<a name="sfbest_Uhead_Uhead_nav_nav3" href="#" class="trackref 
																																			">全球美食</a>
									</li>
							<li id="cat3">
					<a name="sfbest_Uhead_Uhead_nav_nav4" href="#" class="trackref 
																																			">优选厨房</a>
									</li>
							<li id="cat4">
					<a name="sfbest_Uhead_Uhead_nav_nav5" href="#" class="trackref 
																																			">新品尝鲜</a>
									</li>
							<li id="cat5">
					<a name="sfbest_Uhead_Uhead_nav_nav6" href="#" class="trackref 
																																			">优选国际</a>
									</li>
							<li id="cat6">
					<a name="sfbest_Uhead_Uhead_nav_nav7" href="#" class="trackref 
																																			">企业专区</a>
									</li>
			              <!--
